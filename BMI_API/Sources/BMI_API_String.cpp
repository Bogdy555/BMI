...
const size_t BMI_API::String::Length(const wchar_t* _Str)
{
	if (!_Str)
	{
		return 0;
...
const bool BMI_API::String::TheSame(const wchar_t* _Str1, const wchar_t* _Str2)
{
	if (!_Str1 || !_Str2)
	{
		return false;
...
const bool BMI_API::String::Contains(const wchar_t* _Str, const wchar_t _Chr)
{
	if (!_Str)
	{
		return false;
...
const wchar_t* BMI_API::String::TokenizeWhiteSpace(wchar_t* _Str)
{
